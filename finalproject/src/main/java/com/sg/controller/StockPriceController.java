...
import com.sg.Services.ExcelHelper;
import com.sg.Services.StockPriceServiceI;
...
public class StockPriceController {
	...
	@Autowired
	private StockPriceServiceI stockpriceservice;
	@Autowired
	...
	@GetMapping("/{companyid}/{stockexchange}/{in}/{out}")
			 ...
			 Date in ,@PathVariable("out") Date out)
	 {
		 ...
		 return   new ResponseEntity<List<StockPrice>>(stockpricerepo.allStockPrice(companyid, stockexchangename, in, out),HttpStatus.OK);
